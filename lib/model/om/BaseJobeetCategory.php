...
abstract class BaseJobeetCategory extends BaseObject  implements Persistent {
  ...
  const PEER = 'JobeetCategoryPeer';
	...
	/**
	 * @var        array JobeetCategoryI18n[] Collection to store aggregation of JobeetCategoryI18n objects.
	 */
	protected $collJobeetCategoryI18ns;

	/**
	 * @var        Criteria The criteria used to select the current contents of collJobeetCategoryI18ns.
	 */
	private $lastJobeetCategoryI18nCriteria = null;
  ...
  protected $culture;
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 1; // 1 = JobeetCategoryPeer::NUM_COLUMNS - JobeetCategoryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collJobeetCategoryI18ns = null;
			$this->lastJobeetCategoryI18nCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collJobeetCategoryI18ns !== null) {
				foreach ($this->collJobeetCategoryI18ns as $referrerFK) {
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getJobeetCategoryI18ns() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addJobeetCategoryI18n($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collJobeetCategoryI18ns collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addJobeetCategoryI18ns()
	 */
	public function clearJobeetCategoryI18ns()
	{
		$this->collJobeetCategoryI18ns = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collJobeetCategoryI18ns collection (array).
	 *
	 * By default this just sets the collJobeetCategoryI18ns collection to an empty array (like clearcollJobeetCategoryI18ns());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initJobeetCategoryI18ns()
	{
		$this->collJobeetCategoryI18ns = array();
	}

	/**
	 * Gets an array of JobeetCategoryI18n objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this JobeetCategory has previously been saved, it will retrieve
	 * related JobeetCategoryI18ns from storage. If this JobeetCategory is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array JobeetCategoryI18n[]
	 * @throws     PropelException
	 */
	public function getJobeetCategoryI18ns($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(JobeetCategoryPeer::DATABASE_NAME);
		}
		...
		if ($this->collJobeetCategoryI18ns === null) {
			if ($this->isNew()) {
			   $this->collJobeetCategoryI18ns = array();
				...
				$this->collJobeetCategoryI18ns = JobeetCategoryI18nPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				JobeetCategoryI18nPeer::addSelectColumns($criteria);
				if (!isset($this->lastJobeetCategoryI18nCriteria) || !$this->lastJobeetCategoryI18nCriteria->equals($criteria)) {
					$this->collJobeetCategoryI18ns = JobeetCategoryI18nPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastJobeetCategoryI18nCriteria = $criteria;
		return $this->collJobeetCategoryI18ns;
	}

	/**
	 * Returns the number of related JobeetCategoryI18n objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related JobeetCategoryI18n objects.
	 * @throws     PropelException
	 */
	public function countJobeetCategoryI18ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(JobeetCategoryPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collJobeetCategoryI18ns === null) {
			if ($this->isNew()) {
				...
				$count = JobeetCategoryI18nPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastJobeetCategoryI18nCriteria) || !$this->lastJobeetCategoryI18nCriteria->equals($criteria)) {
					...
					$count = count($this->collJobeetCategoryI18ns);
				}
			} else {
				$count = count($this->collJobeetCategoryI18ns);
			}
	...
	/**
	 * Method called to associate a JobeetCategoryI18n object to this object
	 * through the JobeetCategoryI18n foreign key attribute.
	 *
	 * @param      JobeetCategoryI18n $l JobeetCategoryI18n
	 * @return     void
	 * @throws     PropelException
	 */
	public function addJobeetCategoryI18n(JobeetCategoryI18n $l)
	{
		if ($this->collJobeetCategoryI18ns === null) {
			$this->initJobeetCategoryI18ns();
		}
		if (!in_array($l, $this->collJobeetCategoryI18ns, true)) { // only add it if the **same** object is not already associated
			array_push($this->collJobeetCategoryI18ns, $l);
	...
	{
		if ($deep) {
			if ($this->collJobeetCategoryI18ns) {
				foreach ((array) $this->collJobeetCategoryI18ns as $o) {
  ...
  {
    return $this->getCurrentJobeetCategoryI18n($culture)->getName();
  }

  public function setName($value, $culture = null)
  {
    $this->getCurrentJobeetCategoryI18n($culture)->setName($value);
  }

  public function getSlug($culture = null)
  {
    return $this->getCurrentJobeetCategoryI18n($culture)->getSlug();
  }

  public function setSlug($value, $culture = null)
  {
    $this->getCurrentJobeetCategoryI18n($culture)->setSlug($value);
  }

  protected $current_i18n = array();

  public function getCurrentJobeetCategoryI18n($culture = null)
  {
    if (is_null($culture))
    {
    ...
    {
      $obj = $this->isNew() ? null : JobeetCategoryI18nPeer::retrieveByPK($this->getId(), $culture);
      if ($obj)
      {
        $this->setJobeetCategoryI18nForCulture($obj, $culture);
      }
      else
      {
        $this->setJobeetCategoryI18nForCulture(new JobeetCategoryI18n(), $culture);
  ...
  public function setJobeetCategoryI18nForCulture($object, $culture)
  {
    $this->current_i18n[$culture] = $object;
    $this->addJobeetCategoryI18n($object);
  }
